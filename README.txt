To get the skeleton running, open a terminal and do the following:
	1. enter the folder where you placed all the files from github
	...
	5. open app.py using your favorite editor, change #your password here in 'app.config['MYSQL_DATABASE_PASSWORD'] = '#your password here'' to your MySQL root password
